 ...
 * "Unexpected error". Reject those here as a usage error, along with a blank value
 * (a blank `--token ""` silently cancelled a valid env token). Tab (0x09) and Latin-1
 * (e.g. "ü") are allowed — exactly what Node sends. Checked by char code so the
